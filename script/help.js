...
const helpContent = [
    ...
    '<h4>这种矩阵录入方式太麻烦了，有没有更简单的录入方式？</h4><p>点击"更多"按钮，选择"导入二维数组为矩阵"，可以输入标准二维数组格式的矩阵数据，例如：[[1,2],[3,4]]。</p><p>输入完成后点击录入矩阵按钮，即可完成录入。</p>',
    ...
    '<h4>初等变换后，矩阵元素好复杂，看不出元素之间的关系，怎么办？</h4><p>1.点击你认为复杂的矩阵元素。</p><p>2.点击"更多"按钮，选择"多项式展开"可以展开复杂的数学表达式。选择"一元多项式因式分解"可以因式分解。</p><p>若对处理结果不满意，可以点击"替换矩阵元素"按钮对单个矩阵元素进行替换。</p>',
